...
# [Лабораторна робота 17](https://github.com/BohdanSharubin/java-university-project/tree/lab17)
### Вимоги до реалізації
- Операції update і delete повинні виконуватися через методи агрегуючого класу, а не безпосередньо в драйвері.
- Колекція не повинна змінюватися напряму з main.
- Передбачте коректну обробку порожньої колекції.
- Передбачте обробку ситуації, коли об’єкт не знайдено.
# [Лабораторна робота 18](https://github.com/BohdanSharubin/java-university-project/tree/lab18)
### Вимоги до реалізації
- Проєкт на основі ЛР17 доповнений власними винятками.
- Винятки коректно кидаються та обробляються.
- Створені автотести перевіряють кидання винятків.
- Всі зміни зафіксовані у GitHub.